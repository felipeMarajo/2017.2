...
import functools
from Interface import janela_3, warning, functions_criterio
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow, crit, ativ, obj):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 80, 621, 241))
        ...
        self.label.setGeometry(QtCore.QRect(20, 6, 601, 71))
        font = QtGui.QFont()
        font.setPointSize(11)
    ...
    def central_funcao(self):
        try:
            ...
            janela_3.ui.setupUi(janela_3.MainWindow, criterio, atividade, objetivo, eigen, lambd, ci, cr)
            janela_3.MainWindow.show()

            janela_3.ui.pushButton.clicked.connect(functools.partial(janela_3.ui.preencher_Atividades))
    ...
    def preencher_Criterio(self):
        ...
        try:
            ...
            warning.MainWindow = QtWidgets.QMainWindow()
            warning.ui = warning.Ui_MainWindow()
            warning.ui.setupUi(warning.MainWindow, "    Valor Inválido ou os valores\n"
