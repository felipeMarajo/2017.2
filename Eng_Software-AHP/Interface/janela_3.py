...
from Interface import finish, Janela_2, functions_criterio, warning, functions_atividade
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow, crit, ativ, obj, _eigen, _lambd, _ci, _cr):
        ...
        self.Texto.setGeometry(QtCore.QRect(10, 10, 781, 101))
        ...
        for i in range(len(criterio)):
            ...
            self.tabWidget.setGeometry(QtCore.QRect(10, 120, 781, 381))
            self.tabWidget.setObjectName("tabWidget")
            self.tableWidget.setColumnCount(len(atividade))
            self.tableWidget.setRowCount(len(atividade))

            self.tableWidget.setGeometry(QtCore.QRect(0, 0, 774, 351))
    ...
    def central_funcao(self):
        try:
            ...
            finish.ui.pushButton.clicked.connect(functools.partial(functions_atividade.close_multi_windows))
        except ValueError as e:
            warning.MainWindow = QtWidgets.QMainWindow()
            warning.ui = warning.Ui_MainWindow()
            warning.ui.setupUi(warning.MainWindow, "   Digite apenas números!\n"
            ...
            warning.MainWindow = QtWidgets.QMainWindow()
            warning.ui = warning.Ui_MainWindow()
            warning.ui.setupUi(warning.MainWindow, "     Valor Inválido ou nulo!\n"
                                                   "1- verifique se preencheu todas\n"
                                                   "as matrizes com valores numéricos")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Texto.setText(_translate("MainWindow", "Preencha a triangular inferior de TODAS as matrizes em relação "
                                                    "a cada critério\n\nCheque as abas de critérios!"))
