...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(543, 305)
        self.centralWidget = QtWidgets.QWidget(MainWindow)
        self.centralWidget.setObjectName("centralWidget")
        self.pushButton = QtWidgets.QPushButton(self.centralWidget)
        self.pushButton.setGeometry(QtCore.QRect(230, 220, 81, 31))
        ...
        self.writeObjetivo.setGeometry(QtCore.QRect(50, 30, 441, 31))
        self.writeObjetivo.setObjectName("writeObjetivo")
        self.label_2 = QtWidgets.QLabel(self.centralWidget)
        self.label_2.setGeometry(QtCore.QRect(10, 70, 521, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.writeCriterio = QtWidgets.QLineEdit(self.centralWidget)
        self.writeCriterio.setGeometry(QtCore.QRect(50, 100, 441, 31))
        self.writeCriterio.setObjectName("writeCriterio")
        self.label_3 = QtWidgets.QLabel(self.centralWidget)
        self.label_3.setGeometry(QtCore.QRect(10, 140, 521, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.writeAtividades = QtWidgets.QLineEdit(self.centralWidget)
        self.writeAtividades.setGeometry(QtCore.QRect(50, 170, 441, 31))
